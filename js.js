...
var mymap = L.map('mapa').setView([22.2553, -97.8686], 13);
...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1Ijoid2Fya2VyIiwiYSI6ImNrbmp3emI5aTA0b3MybmxiNDV0b3pmeXUifQ.5hyoy0m7upb9gFa6ng27yA'
}).addTo(mymap);
...
function onMapClick(e) {
    ...
    requestPronosticoTiempo(e.latlng,e.latlng)
}
